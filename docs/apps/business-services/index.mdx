...
To edit or delete a Service Type, click on the Service Type name on the Business Service's view page to access the Service Type's edit and delete options. 
