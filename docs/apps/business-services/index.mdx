...
You can visualize the [Business Service relationships](#business-service-relationships) described above using a Sankey chart in [Insights+](/reports/reports/insights-plus.mdx). Download the pre-built dashboard and import it into your instance:
