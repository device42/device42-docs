...
Device42 Business Services offers a powerful method for building custom maps of business-critical functions. Business Services differ from [Application Groups](/apps/application-groups/) in appearance and design. Business Services are not automatically built out based solely on discovered connections and devices, they can be designed and customized entirely by you, and can _include any and all of the resources that you identify as critical to your business!_
...
- Enter the application **Name** and select the **Service Type** (COTS, COTS with Customization, or Custom). Optionally, add a **Service Level**. You can also define the **Vendor** and **Version** of the service.

   - You can add a new Service Type by clicking the **+** button next to the Service Type field. See [Edit or Delete a Service Type](#edit-or-delete-a-service-type) below to edit or delete the Service Type itself.

    <ThemedImage
      alt="Service Type"
      sources={{
        light: useBaseUrl('/assets/images/business-services/add-service-type-light.png'),
        dark: useBaseUrl('/assets/images/business-services/add-service-type-dark.png'),
      }}
    />
...
<ThemedImage
  alt="Add Resources, Devices, and App Comps"
  sources={{
    light: useBaseUrl('/assets/images/business-services/add-inline-light.png'),
    dark: useBaseUrl('/assets/images/business-services/add-inline-dark.png'),
  }}
/>

Remove inline items by clicking the **Tashcan** icon. The item to be removed with be grayed out, giving you the option to restore the item in this session by clicking the **Restore** icon.

<ThemedImage
  alt="Restore button"
  sources={{
    light: useBaseUrl('/assets/images/business-services/restore-button-light.png'),
    dark: useBaseUrl('/assets/images/business-services/restore-button-dark.png'),
  }}
/>
...
Click the **Edit** button on the top right of the canvas to activate the **Edit** mode.

<ThemedImage
  alt="Blank visualization canvas"
  sources={{
    light: useBaseUrl('/assets/images/business-services/blank-canvas-light.png'),
    dark: useBaseUrl('/assets/images/business-services/blank-canvas-dark.png'),
  }}
/>
...
You can add multiple items of each item type at a time for efficiency. 

<ThemedImage
  alt="Add Device button"
  sources={{
    light: useBaseUrl('/assets/images/business-services/canvas-left-panel-light.png'),
    dark: useBaseUrl('/assets/images/business-services/canvas-left-panel-dark.png'),
  }}
/>
...
- Drag an **Application Group** block to the canvas to bring up the Add Application Group box. Search for an Application Group by typing the name of the Application Group in the search box. You can also click the **+** button to add a new Application Group.
...
To add a device to a Business Service, drag a **Device** block to the canvas – this will open the **Add Device** box. You can search for a device by typing the name of the device in the search box.

Select a device from the list, and then click **Add**. Device42 adds the device to the canvas. Additionally, you can click the **+** button to add a new device.
...
Click the **Edit** button on a Business Service's view page, make your changes, and click **Save**.
...
Navigate to the Business Service's view page and click on the name of the Service Type to access the Service Type's edit and delete options. 
...
- Deleting a Service Type will delete the Business Services that use that Service Type.
...
Make maintaining Business Services easier by automatically adding and removing connections. Check the **Auto Apply changes** box when configuring the alert. Connections to a newly found AG dependency will be automatically made and if an AG dependency is removed the Business Service connection will be automatically removed. You will receive a notification of these events as part of the alert.

The **Auto Apply changes** option is unchecked by default. If left disabled, you'll receive a notification with the Add or Remove connection option to manually make changes to the Business Service.
...
Select **Analytics > Notifications** from the menu bar.
...
For detailed instructions on [how to export a business service to the Azure cloud](integration/external-integrations/azure-migrate.mdx), go to the [Azure Migrate](integration/external-integrations/azure-migrate.mdx) integration page.
