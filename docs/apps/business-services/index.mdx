...
> When the individual Business Service Jupiter service app hasreported New Application Group Dependency Found then send notification to users assigned to Main profile.
