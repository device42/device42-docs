...
- Enter the application **Name** and select the **Service Type** (COTS, COTS with Customization, or Custom) and add a **Service Level** if wanted. You can also define the **Vendor** and **Version** of the service.

   - You can also add a new Service Type by clicking the **+** button next to the Service Type field.
...
Search for a component by typing the name of the component in the search box. You can also click the **+** button to add a new component.
