...
You can also check which Business Services a device belongs to from the **All Devices** list or the device record itself. On the **All Devices** list, use the **System Column List** settings to display the optional **Business Services** column. Each Business Service in the column links to its details page. From the device record, open the **Info** tab to see the associated Business Services.
...
- Select an **Impact** of **Critical**, **High**, **Medium**, or **Low**. Impact and **Criticality** are separate values, so you can use each according to your organization's risk and service-management model. The Impact value is also available through the API, DOQL, and Standard Reports.

    <ThemedImage
      alt="Business Service Impact dropdown"
      sources={{
        light: useBaseUrl('/assets/images/business-services/bs-impact-dropdown-light.png'),
        dark: useBaseUrl('/assets/images/business-services/bs-impact-dropdown-dark.png'),
      }}
    />
