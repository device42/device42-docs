...
**Rename an object:** Select it, double-click the name, and type a new name.
...
To delete a connection, select it and press the **Delete** key, or right-click and select **Delete** from the context menu.
