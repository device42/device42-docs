...
- From the list page, you can then bulk manage Application Groups using options from the **Actions** menu, view the [Impart Charts](#impact-charts) of your Application Groups, and search and filter the records. You can also pin Application Groups to keep important items at the top of the list.
