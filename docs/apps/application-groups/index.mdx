...
- For each suggestion you can click **Accept** or **Ignore** on the suggested Application Group, and if you hit **Ignore** an **Undo** button pops up so you can flip the action back.
