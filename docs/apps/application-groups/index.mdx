...
You can view the devices and root resources displayed in the chart in a handy, tabulated list view. Note that this chart list view is only available via the **Chart** view, and not via the **Breakdown** panel on the AG main page. 
