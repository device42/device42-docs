...
You view the devices and root resources displayed in the chart in a handy list view table. Note the chart list view is only available via the **Chart** view, and not the via the **Breakdown** panel on the AG main page. 
