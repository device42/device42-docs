...
:::note
Affinity Groups have been renamed to **Application Groups**. AppFocus Filters are now called [**Application Group Calculation Rules**](calculation-rules.md).
:::

Application Groups are an opinionated view of the impactful applications and their dependencies in your environment. They are configurable via [Calculation Rules](calculation-rules.md) (and templates). Application Groups are based on the communication patterns observed in your environment.
...
:::note
Pin Application Groups to keep important items at the top of the list for quick access.
:::
