...
This page explains how to enable and configure Application Dependency Mapping (ADM) in your autodiscovery jobs, view discovered dependencies, and work with Application Groups.
...
:::tip
After configuring ADM sampling on the autodiscovery job, see the [Application Group Calculation Rules](/apps/application-groups/calculation-rules.mdx) page for a further explanation of how Starting Points are used to generate Application Groups. 
:::
