...
:::info
Set up Application Groups by defining a Starting Point or processing one of our predefined Calculation Rules. See the [Application Groups Calculation Rules](/apps/application-groups/calculation-rules.mdx) page for more details.
:::
...
You can also use Enterprise Dependency Mapping to create [Application Components](/apps/application-components/index.mdx) for the following list of applications.
