...
Once converted, the process is treated as a full Service and can be used like any other service, for example, in Application Components and [AppFocus filters](apps/application-groups/calculation-rules/index.mdx).
