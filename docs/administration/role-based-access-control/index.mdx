...
When role-based access is enabled, you'll see the view-only **Group Permissions** field on the details page of objects:
...
The **Inherited Permissions** are those that are inherited from the parent group - such as a room that inherits permissions from a building. 
...
You can assign Admin Groups to objects from the list view of the object or the edit page of a specific object. You can also assign Admin Groups to discovered objects.

From the list view of the object, you can bulk select the objects you want to assign permissions to. From the **Actions** dropdown, select the **Assign Permissions** action.
