...
:::note
In the v19.05 UI, the Object Category field is hidden on the device view page if role-based access is turned off. Turn on [**Role-Based Access Control**](#setting-up-role-based-access) or use the click the **Legacy View** button on the device view page to see the field.
:::
