...
Note that you can create a new user by clicking the **+ Add Local Admin** button on the Administrators page.

### Cloning Permission Groups

You can clone groups using the **Save as new** option. This makes it easier to create new groups by adding permissions to existing groups.
