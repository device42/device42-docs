...
Device42 includes the enabled **Remove Undetected Software Installations** rule. It deletes software-in-use records with a [Days Undetected](/infrastructure-management/software/software-in-use#days-undetected) value greater than 31.
