...
Find the Markdown file corresponding to the page you want to add the image to. In this example, the article is titled "Using APIs for Custom Autodiscovery", and the Markdown folder is named `using-apis-for-custom-auto-discovery.md`.
