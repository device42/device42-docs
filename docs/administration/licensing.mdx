...
- **Browse** to located your the `.lic` license file on your machine. Click **Upload & Apply**.
...
Two weeks before your license expires, on the home page of your Main Appliance, you'll see a red banner with a notification message counting down the days to the expiration date. 
...
The lower portion of the page under **Tools > Settings > Licensing** displays the number of purchased licenses and the number of license units consumed by the different discovered components.
