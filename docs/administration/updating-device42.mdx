...
When the Device42 Main Appliance is updated, the updates are automatically applied to your Remote Collectors as part of the overall Device42 update process, so long as the Remote Collectors are connected to a Device42 Main Appliance.

If your Remote Collectors are connected to a Device42 Main Appliance, updates will be automatically applied to the Remote Collectors when the Main Appliance is updated.
