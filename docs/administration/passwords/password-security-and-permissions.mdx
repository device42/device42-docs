...
- **View / Change permission** is needed to view the secret in the menu, but the permission is controlled granularly for each Secret. So, globally you can assign the view/change permission to a group, but it would not give that group permission to edit specific Secrets. It would only enable the group to see the Secret.
...
From the Secrets list page, you can edit group permissions of many Secrets at once by selecting **Change group permissions for selected passwords** from the **Actions** dropdown menu. 
