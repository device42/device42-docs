...
- Use the checkboxes to clear the existing group permissions for viewing and editing Secrets.
  ...
  <ThemedImage
    alt="Remove current settings"
    sources={{
      light: useBaseUrl('/assets/images/secret-security-permissions/change-group-action-light.png'),
      dark: useBaseUrl('/assets/images/secret-security-permissions/change-group-action-dark.png'),
    }}
  />
...
- Select new permission groups using the dropdown menu.
  ...
  <ThemedImage
    alt="Change group permissions"
    sources={{
      light: useBaseUrl('/assets/images/secret-security-permissions/add-group-action-light.png'),
      dark: useBaseUrl('/assets/images/secret-security-permissions/add-group-action-dark.png'),
    }}
  />
