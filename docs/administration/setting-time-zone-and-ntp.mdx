...
After you've selected the correct new time zone and received confirmation that it has been applied, go to the Device42 console and restart the Device42 application \[Option #2\]. When it restarts, the console menu will show the new time zone.

- Use VM console menu options, **NTP Settings** and **Set Timezone**, to set time at the OS level.
