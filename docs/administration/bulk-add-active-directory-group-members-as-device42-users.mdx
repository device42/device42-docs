...
The **Users** listed are AD users that are displayed as a result of the choices on the prior screen. Note the **Groups** are not AD groups - they are Device42 Groups.
