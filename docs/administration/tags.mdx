...
From the Tags list page, select two or more tags, choose **Merge selected tags** from the **Actions** dropdown.
...
There are serveral ways to find tags that aren't associated with any objects: 
