...
If there is an issue, the network is not reachable, or you simply prefer using the terminal, you can alternatively run the following from any machine that has 'snmpwalk' installed:
