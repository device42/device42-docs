...
- Click **Download Archive File** and save the file to attach to an existing support ticket. If needed, [create a new ticket](https://support.device42.com/) or [email support](mailto:support@device42.com).
