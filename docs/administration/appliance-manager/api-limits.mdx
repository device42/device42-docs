...
From the Appliance Manager, you can set a limit on the number of remote agents that can attempt to update at once. This option is intended for administrators with hundreds of agents and need to prevent those agents from simultaneously attempting to update, possibly causing the Main Appliance to be overloaded.
