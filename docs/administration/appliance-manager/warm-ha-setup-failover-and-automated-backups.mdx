...
From the [Device42 Appliance Manager](/administration/appliance-manager/device42-appliance-manager-login), you can set the appliance to standby mode and configure it to restore from a backup file on a remote server. The appliance will then automatically restore from the backup file at the intervals you specify.
...
For details, see [backup metadata](/administration/appliance-manager/setting-up-backup-device42-appliance-manager#backing-up-metadata) and [scheduling the backup](/administration/appliance-manager/setting-up-backup-device42-appliance-manager#scheduling-the-backup).
