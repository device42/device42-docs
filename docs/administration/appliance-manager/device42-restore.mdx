...
1. Spin up a new device42 virtual appliance and restore there. Note: A second instance can also be used for disaster recovery / business continuity purposes. As described in our ["Warm HA Configuration."](administration/appliance-manager/warm-ha-setup-failover-and-automated-backups.mdx)
