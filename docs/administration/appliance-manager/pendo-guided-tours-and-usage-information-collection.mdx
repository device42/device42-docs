...
Device42 collects certain usage information to help us better assist users and prioritize future product updates, and provide guided product tours for Device42 features.
...
- To disable the collection of usage data, uncheck the **Allow usage metric sharing** option – the **Allow Guided Product Tours** option will also also be disabled.
