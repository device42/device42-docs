---
title: "Backup and Restore from the Appliance Manager"
sidebar_position: 18
---
...
In the Appliance Manager, navigate to **Backup/Restore > Restore** and select **Main Appliance** or **Remote Collector**. You need separate backup `.enc` files for the Main Appliance and Remote Collector.

![Restore](/assets/images/setting-up-backup-device42-appliance-manager/restore-ma.png)
...
![Restore success](/assets/images/setting-up-backup-device42-appliance-manager/ma-restore-success.png)
