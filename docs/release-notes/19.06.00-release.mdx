---
title: "19.06.00 Release"
sidebar_position: 2
---

:::info
The following release notes were taken from [this blog post](https://www.device42.com/blog/2025/05/06/business-service-and-freshservice-enhancements-v19-06-ma/). The [Device42 blog](https://www.device42.com/blog/category/release/) remains the authoritative source for release notes.
:::
...
Improved the user experience around using Business Services by including the ability to add attachments and create custom types, and by improving tooltips and other minor items.
...
- D42-38292: Added the ability to add attachments to Business Services via the API.
...
- D42-23111: Fixed an error with the `Cables` API call.
...
- D42-37740: Hid unpopulated Custom Fields in view pages.
...
- D42-38593: Audit logs (History) details do not allow users to scroll to see the change history details.
...
- D42-38432: Fixed an issue with Fortinet Firewall discovery no longer capturing interfaces, IPs, and subnets after upgrade to FortiNet OS 7.2.x.
...
- D42-37773: Fixed an issue with CiscoASA cluster detection.
...
- D42-37636: Custom dropdowns with many items now resize dynamically.
...
- D42-38715: Fixed a timeout in NFS autorestore functionality.
...
- D42-36547: Export to Excel now generates multiple tabs when there are more than a million rows.
- D42-35840: The 'Client Process Display Name' field is now case sensitive.
- D42-35716: You can now change custom picklists to multi-select picklists.
