...
## Updating Device42 to Version 19.07.10

Upgrading to 19.07.10 is possible from 19.05.10 or above. If you need to first upgrade to Version 19.05.10, please see those release notes for details. A link will also be provided when requesting an upgrade. We recommend making a backup of your system before any upgrades.

The 19.07.10 MA release contains the following features:
...
- D42-39699 Fixed an issue with Chatsworth PDU's getting flipped and duplicated
...
- D42-41422	Upgrade may fail on updating the database
...
- D42-40404 Fixed an issue manually setting CPU speed
