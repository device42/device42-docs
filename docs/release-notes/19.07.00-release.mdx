...
:::info
The following release notes were take from the [Device42 blog](https://www.device42.com/blog/2025/08/20/saas-discovery-and-business-service-improvements-v19-07-ma/). The [Device42 blog](https://www.device42.com/blog/category/release/) remains the authoritative source for release notes.
:::
...
- D42-39699 Fixed and issue with Chatsworth PDU's getting flipped and duplicated
...
- D42-39803 Fixed and issue with the agent gathering the correct SID for last login
