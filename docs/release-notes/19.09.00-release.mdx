...
import itsmAlertImage from '/assets/images/release-notes/19.09-itsm-integration-alert.png';
import itsmAlertDetailImage from '/assets/images/release-notes/19.09-itsm-integration-alert-2.png';
...
<img src={itsmAlertImage} alt="ITSM integration alert rule configuration" width="100%"/>

<img src={itsmAlertDetailImage} alt="ITSM integration alerts list" width="100%"/>
