...
:::info
We're recording a new how-to video for the Device42 Object Query Language (DOQL). Please see the [DOQL page here](/reports/device42-doql/) for more information.
:::

**Old Video Transcript**
