...
:::info
We're still working on a new video on how to use Jira with Device42. Please see the [Jira Integration page](/integration/external-integrations/jira-integrations/) for more information.
:::
