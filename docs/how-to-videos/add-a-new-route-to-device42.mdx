...
**If you'd prefer written instructions for adding a route, they can also be found on the docs site at: [Setup & Troubleshooting -> Advanced Routing](administration/advanced-routing.mdx).**
