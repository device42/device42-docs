...
To discover a UCS or other Cluster Device, select "UCS" from the **Platform:** drop down (pictured above). _Visit the [dedicated Cisco UCS / ACI discovery docs page](/auto-discovery/cisco-ucs-auto-discovery/) for more information._
