...
Gain visibility into your SaaS usage to identify under or overused applications and subscriptions and capture user access details. Schedule SaaS discovery to maintain an up-to-date inventory of SaaS information.
...
- **Software components:** Includes details such as Software Type ('managed'), License Model (such as 'Individual - User/Subscription'), and Vendor.
- **Software in use:** Includes fields for Version, Install Date, and End User.
