...
<ThemedImage
  alt="Storage array platforms v19.05"
  sources={{
...
Select **Discovery > Storage Arrays** in the Device42 menu to display the **Storage Arrays** discovery list page, and then click **Create** to create a new discovery job.  
...
When you are done, click **Save** and you'll see the **Run Now** button to run the job immediately. You can also run the job immediately from the Storage Array list page. 

### Schedule the Job

Use the **Autodiscovery Schedule** section of the page to schedule when your job runs. You can create multiple schedules for each job. Select the days of the week and the time to run the job.  
