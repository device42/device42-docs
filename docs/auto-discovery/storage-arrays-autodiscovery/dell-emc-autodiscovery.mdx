...
This page details access protocols and configuring read-only user accounts with minimum permissions for use in Dell or EMC storage array autodiscovery.
...
| Dell   | VNX/VMAX | SMIS | 5988 / 5989 |
| EMC    | Data Domain | REST / SSH | 3009 / 22 |
| EMC    | Unity | REST | 443 |
