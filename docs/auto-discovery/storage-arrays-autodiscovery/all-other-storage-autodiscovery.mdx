...
Configure discovery credentials for Infinidat, NetApp, Nutanix, Oracle ZFS, and Pure Storage arrays.

## Access Protocols by Array

Table showing supported storage arrays and access methods.

| Vendor | Array | Access Mechanism | Default Port |
|--------|-------|------------------|--------------|
| Infinidat | Infinidat | REST | 443 |
| NetApp | FAS Series | Vendor API | 80/443 |
| Nutanix | Nutanix | REST | 9440 |
| Oracle | ZFS | REST | 80/443 |
| Pure Storage | Pure Storage | REST | 80/443 |
