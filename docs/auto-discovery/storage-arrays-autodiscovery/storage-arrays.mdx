...
:::note
The **Storage Arrays** list page also includes an **Advanced Search** option you can use to construct more specific searches. See the [Advanced Search Feature](/getstarted/using-device42/advanced-search-feature.mdx) documentation page for instructions.
:::
...
Click **Edit** on the storage array view page to edit the array. You can add or edit **Notes** (1) or **D42 Tags** (2) for the array, toggle the **In Service** (3) indicator on or off, and select or add a **Service Level** value (4).
...
To delete items, choose **Delete with Detailed Confirmation**, **Fast Background Delete**, or **Fast Background Archive** from the **Actions** dropdown menu.
...
- **Browse** to the Excel file and click **Upload** to add the storage array discovery jobs to Device42.
