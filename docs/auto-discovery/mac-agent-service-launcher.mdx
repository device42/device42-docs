...
2. Download the `.plist` file from the website
3. Modify the `.plist` file as required based on your setup and required options
4. You need the config file and executable for `/opt/device42/` 
5. You need the `.plist` file for `/Library/LaunchDaemons/`
