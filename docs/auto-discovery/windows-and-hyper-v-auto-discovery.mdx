...
- Minimum required permissions for discovering **services and application data** for [Application Dependency Mapping (ADM)](/reports/dbb-cookbook/app-dependency-mapping/) on Windows.
