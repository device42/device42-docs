...
2. For Windows or Hyper-V discovery, select **Windows** as the **Platform**.
    ...
    :::note 
    We don't deem it necessary to update existing jobs to use WinRM, as currently we use NTLM, which Microsoft is in the process of deprecating. We'll use Kerberos in the near future.
    :::
...
sources={{
    light: useBaseUrl('/assets/images/windows-and-hyper-v-auto-discovery/naming-options-light-2.png'),
    dark: useBaseUrl('/assets/images/windows-and-hyper-v-auto-discovery/naming-options-dark-2.png'),
}}
/>
