...
**Enable Resource Utilization Tracking for Device(s):** Enable this option periodically collect and examine server resource usage metrics. See [Resource Utilization](/auto-discovery/resource-utilization-overview/) for more information.
