...
Virtual Machine (VM) hypervisors can be discovered directly from the Device42 UI. These include VMware ESXi (managed via vCenter), as well as other platforms like KVM, oVirt, and Hyper-V.
