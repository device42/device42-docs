...
![Bulk run confirmation dialog](/assets/images/autodiscovery/bulk-run-confirmation.png)

- When all the selected jobs are able to run, a success message appears. 

  ![Bulk run success toast](/assets/images/autodiscovery/bulk-run-success-toast.png)

- If the job(s) fail, the error messages are shown in the dialog box. 

  ![Bulk run error toast](/assets/images/autodiscovery/bulk-run-error-toast.png)
