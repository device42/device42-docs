...
Plan your discovery process by referencing the recommended [Initial Discovery Sequence](/getstarted/getting-started-with-auto-discovery.mdx) and set up your environment to get the most out of discovery process. [Contact our support team](https://support.device42.com/hc/en-us) for additional guidance.
