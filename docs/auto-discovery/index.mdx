...
You can run multiple discovery jobs concurrently.From the autodiscovery job list page, select the jobs you want to run concurrently, select **Run Selected Jobs** from the **Actions** dropdown. 
