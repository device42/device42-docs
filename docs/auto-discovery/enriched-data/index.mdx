...
For OS **End of Life** and **End of Support** dates, the service fills a blank date and can update a date that it previously supplied. It does not replace a manually entered date. When both sources provide a date, Device42 uses the manually entered date.
