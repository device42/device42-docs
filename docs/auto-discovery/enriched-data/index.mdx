...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/enriched-data/enrichai-data-menu-light.png'),
    dark: useBaseUrl('/assets/images/enriched-data/enrichai-data-menu-dark.png'),
  }}
  style={{ width: '90%' }} 
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/enriched-data/lock-button-light.png'),
    dark: useBaseUrl('/assets/images/enriched-data/lock-button-dark.png'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/enriched-data/vendor-list-ai-icon-light.png'),
    dark: useBaseUrl('/assets/images/enriched-data/vendor-list-ai-icon-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Vendor view"
  sources={{
    light: useBaseUrl('/assets/images/enriched-data/vendor-enriched-data-light.png'),
    dark: useBaseUrl('/assets/images/enriched-data/vendor-enriched-data-dark.png'),
  }}
/>
