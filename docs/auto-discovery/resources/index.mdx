...
You can delete selected resources from list pages and landing pages using the **Fast Background Delete** or **Delete with Detailed Confirmation**. Alternatively, you can use the bulk action for archiving root resources.
