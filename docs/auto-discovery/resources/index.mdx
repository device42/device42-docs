...
You can only perform certain bulk actions if your user account is permitted to edit resources. Ensure that the ['Resources | Can change Resource' permission](/administration/role-based-access-control/role-based-permissions-and-access) is enabled before you attempt to use the following bulk actions:
...
You can delete the selected resources from list pages and landing pages using the **Fast Background Delete** or **Delete with Detailed Confirmation**. Alternatively, you can use the bulk action that archives root resources.
