...
The tab displays a visualization of the Application Group calculation data of the selected resource with a single [Starting Point](/apps/application-groups/), and the Resource's related dependencies and impact objects in the diagram.
