...
The tab displays a visualization of the Application Group calculation data for the selected resource, with a single [Starting Point](/apps/application-groups/), and the resource's related dependencies and impact objects in the diagram.
...
You can perform bulk actions if your user account has permission to edit resources. Check with your administrator to ensure that your account has the ['Resources | Can change Resource' permission](/administration/role-based-access-control/role-based-permissions-and-access) enabled.
