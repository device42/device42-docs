...
To delete resources, select one or more resources from the list and choose **Fast Background Delete** or **Delete with Detailed Confirmation**. Alternatively, you can run the **Fast Background Archive** action to archive the resources.
