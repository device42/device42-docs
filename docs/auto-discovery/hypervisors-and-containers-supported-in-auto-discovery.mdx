...
If you are looking for instructions to get started with Hypervisor, Linux (\*nix), or Windows discovery, see the [Windows / Hyper-V Discovery](/auto-discovery/windows-and-hyper-v-auto-discovery.mdx) page or the [Linux / UNIX server auto-discovery](/auto-discovery/linux-unix-server-auto-discovery.mdx) page.
...
For instructions on how to configure and run these discovery jobs, see [Hypervisor Autodiscovery](/auto-discovery/virtual-machine-auto-discovery.mdx). 
...
You have the option to ignore specific IP and MAC addresses globally and for specific jobs. See [Windows and Hyper-V Autodiscovery](/auto-discovery/windows-and-hyper-v-auto-discovery.mdx#option-to-ignore-ipsmac-addresses) for more details.
