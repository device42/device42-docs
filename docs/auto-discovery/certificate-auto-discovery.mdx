...
Newly created jobs will not run on the day they are created to prevent the unintended running of many jobs simultaneously. To run a job after its initial creation, click **Run Now** on the job details page, or the **Certificate autodiscovery specs** list page.
