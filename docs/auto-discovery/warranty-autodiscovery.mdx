...
For the script to successfully retrieve warranty information for a given device, the device model and serial number fields must be correctly filled out (entered or discovered).

### Merge Vendors

If you have multiple vendor entries for any of the supported warranty vendors (for example, "Dell", "Dell Inc.", "Dell Computers"), you should merge these into a single vendor using the vendor names (**Dell**, **IBM**, **Lenovo**, **Meraki**) prior to discovery.
