...
-  Select a service level to apply to devices when no VM is detected, assign the discovered devices to a VRF group, and associate specific customers to the discovered devices. 
