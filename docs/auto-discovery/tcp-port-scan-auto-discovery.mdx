...
- Specify your settings for the discovery of software and services, which have two cloud service options (**Discover ProviderID/Cloud ID** and **Use provider token**:).
