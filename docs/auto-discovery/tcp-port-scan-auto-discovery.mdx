...
- Choose from the two cloud service options in the settings for the discovery of software and services (**Discover ProviderID/Cloud ID** or **Use provider token**:).
