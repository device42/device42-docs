...
Reorder the credentials by clicking on the **up** and **down** arrow buttons to right of the screen.
...
:::note
For SNMP v3 we support the following options for Privacy Protocol only:  **DES, 3DES, AES, and AES128**.
:::
