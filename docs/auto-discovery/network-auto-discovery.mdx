...
Navigate to **Tools > Global Settings** and scroll down to the **Ignore OID(s):** field. Add individual an OID or a group of OIDs using dot notation. For documentation purposes, you can optionally include a comment on the on the same line of the OID(s) using text notation.
