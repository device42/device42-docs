...
:::note
For successful SNMP v3 discovery, please only use one set of v3 credentials per username. Currently, entering multiple SNMP v3 credential with shared passwords results in only one of the credentials sets being used. 
:::
