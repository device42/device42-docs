...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/cloud-services-button-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/cloud-services-button-dark.png'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/view-integration-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/view-integration-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Edit Button"
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/edit-button-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/edit-button-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Disable Button"
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/disable-button-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/disable-button-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Disable prompt"
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/prompt-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/prompt-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Save button"
  sources={{
    light: useBaseUrl('/assets/images/enrich-ai-opt-out/disabled-save-light.png'),
    dark: useBaseUrl('/assets/images/enrich-ai-opt-out/disabled-save-dark.png'),
  }}
/>
