...
Device42 currently displays additional information generated by EnrichAI Data on the vendor and OS view pages that have been enriched. You can identify enriched vendors by the **AI icon** included next to their names on the vendor list page (under **Infrastructure > Vendors**).
