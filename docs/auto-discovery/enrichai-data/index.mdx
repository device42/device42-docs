...
Device42 also currently displays information from EnrichAI Data on vendor and OS view pages that have been enriched. Enriched vendors include the **AI icon** on the vendor list page (under **Infrastructure > Vendors**).
