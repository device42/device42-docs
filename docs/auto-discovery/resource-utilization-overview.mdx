...
Select an interval under the **Resource Utilization Sampling Interval** dropdown – the default period is ten minutes (600 seconds). With RU tracking is enabled, you will not be able to save the discovery job unless an interval is specified. 
