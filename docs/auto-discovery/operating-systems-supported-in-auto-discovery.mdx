...
:::note
All discoveries can be run without agents on the Device42 Main Appliance with the option of using one or more remote collectors. Agentless Windows discovery requires at least one instance of the Windows Discovery Service (WDS) deployed on your network where it can reach your desired discovery targets.
:::
...
The following operating systems have been tested with Device42 discovery:

<table>
  <tbody>
    <tr>
      <td width="450" style={{verticalAlign: 'top'}}>
        <ul>
          <li>AIX 5</li>
          <li>AIX 6</li>
          <li>AIX 7</li>
          ...
          <li>HP-UX 11</li>
          <li>IBM i v7.1 <small>(English and Spanish locales)</small></li>
