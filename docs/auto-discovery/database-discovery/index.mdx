...
To set discovery exclusions, navigate to the **Tools > Settings > Global Settings** page and the **Discovery Exclusions** section.

Enable the **Ignore DB Login Names** setting. When enabled, DB login names will not be collected during database discovery
