...
On the Device42 main menu, select **Resources > Databases > On-Prem Databases** to display the page. If can use the search bar and filters to narrow down the list.
