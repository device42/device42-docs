...
- **Strip domain suffix:** Strips the domain suffix from discovered servers.
...
After saving a discovery job, you can run it immediately using the **Run Now** button on the view and edit pages of the specific job, or from the list page grid under **Discovery > HyperVisors / \*nix / Windows**.
