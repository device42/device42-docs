...
<ThemedImage
  alt="Schedule a UCS or ACI discovery job"
  sources={{
...
If an existing device is not found for the Chassis or the Blade based on the serial number, Device42 will add a new device. The **Name** will be derived from the DN and the serial number of the device.
