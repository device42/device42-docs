...
:::info
See **[Windows Discovery Agent Service Wrapper](/getstarted/deploy-device42/windows-service-installation)** and **[Mac Agent Service Launcher](/auto-discovery/mac-agent-service-launcher)** for information on installing versions of the Windows and Mac discovery agent as a service.
:::
