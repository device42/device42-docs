...
- `https://organizations.us-east-1.amazonaws.com` (Only if one of any of the available features is enabled).
...
**Example IAM Policy** (except for K8s cluster endpoints, since it is controlled by K8s RBAC).
