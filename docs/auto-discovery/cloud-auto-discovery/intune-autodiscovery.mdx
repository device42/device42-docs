...
When Intune reports a recognized hardware model, Device42 uses the model name to assign the appropriate **Physical Subtype**, such as **Laptop**, **Mobile**, or **Tablet**. This prevents recognized devices from being classified as **Generic** and improves device-type synchronization with integrations such as Freshservice.
