...
:::note
In Device42 19.05, Intune discovery has been adjusted to import devices individually instead of in one large block that could time out during very large installations.
:::
