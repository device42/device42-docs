...
Provide you WS1 username and password by creating a secure Secret. Click the **magnifying glass icon** next to **Basic credentials** to add a new Secret.
...
You can also run the job later by navigating back to the **Cloud Autodiscovery** list page and clicking **Run Now** next to the job. 
