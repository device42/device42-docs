...
- Set the **Service Level** of the job to be applied to the discovered items (4). For example, **Development**, **Deployment**, or **Production**.
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/other-cloud-autodiscovery/openstack-job-19.06-light.png'),
    dark: useBaseUrl('/assets/images/other-cloud-autodiscovery/openstack-job-19.06-dark.png'),
  }}
/>
