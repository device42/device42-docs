...
- [Alibaba Cloud Discovery](#alibaba-cloud-discovery)
- [Arista CloudVision Discovery](#arista-cloudvision-discovery)
- [DigitalOcean Discovery](#digitalocean-discovery)
- [Linode Discovery](#linode-discovery)
- [OpenStack Discovery](#openstack-discovery)
  - [OpenStack Discovery Items](#openstack-discovery-items)
  - [Minimum Permission Requirements for OpenStack Discovery](#minimum-permission-requirements-for-openstack-discovery)
  - [Get Details for OpenStack Discovery](#get-details-for-openstack-discovery)
  - [Create an OpenStack Discovery Job](#create-an-openstack-discovery-job)
- [Oracle Cloud Discovery](#oracle-cloud-discovery)
...
Select **Alibaba Cloud** from the **Type:** dropdown menu, name your discovery job, and then add your Alibaba credentials, including both your **Access Key Id** (1) and **Access Key Secret** (2).
...
From Device42, click **Create** on the Cloud Autodiscovery list page and then select **Linode** from the **Type:** dropdown menu. Enter your Linode API key by clicking the **magnifying glass** icon to create a Device42 secret to add to the field.
