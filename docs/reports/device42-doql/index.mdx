...
You can also refer to the Entity Relationship Diagram and Data Dictionary table to get the names of Device42 database tables and columns (fields), and look up relationships. See the [Database Viewer Schema page](db-viewer-schema.mdx) for more details.
