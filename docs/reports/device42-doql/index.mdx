...
You can also refer to the Entity Relationship Diagram schematics and Data Dictionary table to get the names of Device42 database tables and columns (fields) and to improve your understanding of the database schema. See the [Database Viewer Schema page](db-viewer-schema.mdx) for more details.

Please note that Device42 does not provide assistance for writing DOQL queries. However, if you encounter a bug, please report it to our support team at [support@device42.com](mailto:support@device42.com) and we will fix it as part of our normal bug-fixing process.
