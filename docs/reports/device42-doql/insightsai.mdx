...
InsightsAI generates an SQL query with the table and parameters in response to your input. See [Database Viewer Schema](db-viewer-schema.mdx) for information on locating database field names and descriptions.
...
:::tip
See [Device42 Object Query Language](index.mdx) for information on database queries.
:::
