...
InsightsAI generates an SQL query with the table and parameters in response to your input. See [Database Viewer Schema](/reports/device42-doql/db-viewer-schema) for information on locating database field names and descriptions.
...
:::tip
See [Device42 Object Query Language](/reports/device42-doql) for information on database queries.
:::
