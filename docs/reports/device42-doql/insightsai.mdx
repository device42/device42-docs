...
By typing plain English messages, like “Which SSL/TLS certificates are expiring in the next 90 days?” or "Find all Resources where name contains 'Nested,'" InsightsAI will create the query that can be executed without requiring deep knowledge of the query language or data model. You can preview the results and refine the query as needed.
...
Delete one or more chats by selecting them and choosing a delete option from the **Select and action** dropdown.
