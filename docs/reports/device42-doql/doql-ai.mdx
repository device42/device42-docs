...
To save the generated query, click **Report** on the DOQL AI [response toolbar](#query-result-options) to got to the report setup page and provide a **Report Name**.
