...
Apply filters to narrow down the results displayed in the table. Use the **Action Date/Time** dropdown to limit results to a specific duration or date range. 
...
- For discovery job objects, use the **ellipsis icon** to access the history log for the object.
  <ThemedImage
