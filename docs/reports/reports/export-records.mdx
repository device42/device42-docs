...
The **Tools > Exports (CSV)** menu gives you options for exporting data from Device42 into CSV files. You can also export data via the **Reports** menu under **Analytics** and via the APIs.

## Export Records and Generate Reports
...
The following report options are available for exporting:
