...
When displaying the report on screen, click the filter icon in a column header to open its filter panel. 

Add or remove rules, select an operator, enter a value, and choose **Match All** (AND) or **Match Any** (OR) logic. OR logic can also combine rules for different fields. You can use global search together with column filters.

<ThemedImage
  alt="Match Any advanced filter"
  sources={{
    light: useBaseUrl('/assets/images/standard-reports/advanced-filter-match-any-light.png'),
    dark: useBaseUrl('/assets/images/standard-reports/advanced-filter-match-any-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Between date filter"
  sources={{
    light: useBaseUrl('/assets/images/standard-reports/advanced-filter-date-between-light.png'),
    dark: useBaseUrl('/assets/images/standard-reports/advanced-filter-date-between-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Display on Screen actions"
  sources={{
    light: useBaseUrl('/assets/images/standard-reports/display-on-screen-actions-light.png'),
    dark: useBaseUrl('/assets/images/standard-reports/display-on-screen-actions-dark.png'),
  }}
/>
