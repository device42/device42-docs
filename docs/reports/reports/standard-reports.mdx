...
The traditional "Classic Reports" menu option has been renamed to **Standard Reports** under the **Analytics** menu. Standard Reports are generally the quickest and easiest way to query and report on information within Device42. 
...
Select the **Guided Report** option and object to create the report on. Filters can be added and set to alter the report.
