...
Returns an inventory of virtual devices with resource allocations, OS, hypervisor, and cost center data. Use this to audit your virtual assets for missing or incomplete information.
