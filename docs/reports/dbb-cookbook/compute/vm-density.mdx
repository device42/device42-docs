...
Returns vCPU and RAM allocation metrics per hypervisor host, comparing allocated vs. in-service VMs. Use this to manage your physical-to-virtual asset ratios and identify over- or under-utilized hosts.
