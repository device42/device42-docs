...
Select the devices you want to rename from any device list view, like the one located under **Resources > All Devices**.
...
Download and open the spreadsheet. Using the **new\_name** parameter, I created new device names by typing in the first name and dragging the name down allowing Excel to auto-fill the remaining fields. 
