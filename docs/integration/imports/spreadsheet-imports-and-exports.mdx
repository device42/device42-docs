...
Below the **Browse** button, the import results appear under three headers, following the phrase **The following lines from worksheet (name) were...**

- **...added or updated successfully:** Device42 saved every field.
- **...partially added or updated (with warnings):** Device42 saved the record but skipped one or more fields, such as a service level that doesn't exist in your instance.
- **...not added or updated:** Device42 rejected the record. Each partial or rejected record lists the reason at the end of the line.

<ThemedImage
  alt="Successful, partial, and rejected spreadsheet import results"
  sources={{
