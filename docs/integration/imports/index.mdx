...
Import data into Device42 using Excel spreadsheets.
...
- **Bulk Changes**: Make bulk changes to devices using the **Do a re-importable export for selected devices** option. For an example of renaming devices, see [Using the re-importable export feature](using-the-re-importable-export-feature.mdx).