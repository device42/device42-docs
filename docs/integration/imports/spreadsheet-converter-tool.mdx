...
This page is for users who want to prepare a spreadsheet, map its columns, and import the data into Device42. It also shows where to download the tool, how to save mapping templates, and how to create custom fields for device imports.

For a video walkthrough, see [Generic (.CSV) Import Tool How to](/how-to-videos/generic-csv-import-tool-how-to.mdx).
