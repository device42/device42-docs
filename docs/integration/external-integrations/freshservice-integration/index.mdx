...
This means multiple Device42 instances are using the same GUID. Each Device42 instance must have a unique GUID. The primary keeps its GUID, and any duplicate GUIDs on other instances should be regenerated to be unique.
