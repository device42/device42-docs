...
- The Device42 Jenkins plugin (`Device42.hpi`), either [downloaded](https://github.com/device42/device42-jenkins-credentials-plugin/) or built from source (building from source requires **Maven**)
