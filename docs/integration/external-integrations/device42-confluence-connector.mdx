...
This page is for Confluence administrators who want to surface Device42 infrastructure data inside their Atlassian Confluence instance. By the end, you can display and link to Device42 objects within Confluence pages and keep that data synchronized.
...
- A Confluence user with the **Confluence System Administrators** global permission to install the add-on, and **Confluence Administrators** permission to configure it
- A running Device42 instance
- A stable network connection between the server hosting Confluence and the server hosting Device42
