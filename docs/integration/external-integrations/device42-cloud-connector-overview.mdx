...
- [ServiceNow](device42-servicenow-connector.mdx)
...
- [ZenDesk](device42-zendesk-connector.mdx)

Note that the [Cloud Recommendation Engine](reports/reports/cloud-recommendation-engine.mdx) also uses the Cloud Connector.
...
![Cloud connector communication example using ServiceNow integration](/assets/images/cloud-connector-diagram.png)
