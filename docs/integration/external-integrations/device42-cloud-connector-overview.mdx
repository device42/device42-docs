...
This page is for administrators who want to understand how Device42 communicates with cloud-based integrations, and who need to configure that communication. By the end, you know which integrations depend on the Cloud Connector and how to set the Cloud Connector location for your appliance.
...
- Choose which **Cloud Connector** location to use: **USA**, **Europe**, **Australia**, or **India**. Note that only the **USA** location supports the Jira Cloud, Zendesk, and Slack integrations.
