...
Install the [Device42 for Jira Service Management Assets](https://marketplace.atlassian.com/apps/1229672/device42-for-jira-service-management-assets?tab=overview&hosting=cloud) app from the Atlassian Marketplace.
