...
This version of the integration is for Jira Service Management Cloud only. If you are looking to integrate Device42 with a self-hosted version of Jira software, see [Device42-Jira (self-managed) integration page](device42-jira-integration.mdx).
=======
...
>>>>>>> 30b119d (635: add deprecation notice, device42-jira-cloud-integration)
:::
