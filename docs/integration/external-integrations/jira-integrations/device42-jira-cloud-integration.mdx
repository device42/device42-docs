...
:::warning
Please note that [the JSM Assets app](https://marketplace.atlassian.com/apps/1229672/device42-for-jira-service-management-assets) is the currently supported Device42-Jira integration app. It is available on the Atlassian Marketplace.
