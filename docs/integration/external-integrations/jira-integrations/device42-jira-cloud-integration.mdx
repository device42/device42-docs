...
Integrate your Device42 instance with Jira Service Management (JSM) to manage your team's tasks and link them directly to the impacted assets. This page covers installation, configuration, and how to create and link Jira issues from Device42.
...
* Administrator access to a **Jira Cloud account** to install and configure the [Device42 Jira Service Management app](https://marketplace.atlassian.com/search?query=device42).
...
1. Locate the [Device42 for Jira Service Management app](https://marketplace.atlassian.com/search?query=device42) from the Atlassian Marketplace and click on the yellow **Get it now** button to install it.
