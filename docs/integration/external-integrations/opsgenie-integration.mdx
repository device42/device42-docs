...
This page is for administrators who want Device42 alerts to reach their on-call responders in Opsgenie. By the end, a triggered Device42 alert is automatically routed to Opsgenie as an incident.
...
- Access to Opsgenie **Settings** to add an API integration
- An Opsgenie API key with the **Create and Update Access** option enabled
- Administrator access to Device42 to add an external integration and configure alerts
