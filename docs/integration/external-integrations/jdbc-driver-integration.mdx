...
Download the Device42 JDBC driver, which works with any JDBC-compatible client, from the [Device42 Miscellaneous Tools download page](https://www.device42.com/miscellaneous-tools/).
...
![Manage drivers in SQL Workbench](/assets/images/JDBC1-1.png)

5. Create a new profile using the driver you created. Use a URL such as `jdbc:doql://sandbox.device42.com:443`, which uses port 443, along with your Device42 credentials. Replace `sandbox.device42.com` with your own Device42 instance.

![Create a connection profile](/assets/images/JDBC2-1.png)

6. Test a query.

![Test a query against Device42](/assets/images/JDBC3.png)
