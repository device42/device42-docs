...
- The Vault details listed under [Configure HashiCorp Vault](#configure-hashicorp-vault): an AppRole (Role ID and Secret ID) with read access to the required secret paths, the secret engine path, and the namespace if you use multi-tenancy
