...
**This version of the integration is for Jira Service Management Cloud only. If you are looking to integrate Device42 with a self-hosted version of Jira software, see the [Device42-Jira (Self-Hosted) integration page](device42-jira-integration.md).**

**For installation instructions for the [Device42 for JSM **Assets** app](https://marketplace.atlassian.com/apps/1229672/device42-for-jira-service-management-assets?hosting=cloud&tab=overview), see the [JSM Assets integration page](jira-assets-itegration.mdx)**.
