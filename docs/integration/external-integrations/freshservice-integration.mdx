...
4. Choose between the login options:

- **Auto Login**: Device42 will try to log you in automatically – without first directing you to the login page. If auto-login fails you will be directed to the login page.
- **Show Login Page**: Always be directed to the login page (with buttons for normal and SSO login).

5. Restart your Device42 instance. From the Appliance Manager, go to **Application > Restart Application** and check the confirmation box before restarting Device42.
...
Before deleting the Freshservice external integration in Device42 or making changes to your Cloud Services configuration, first uncheck the **Enable Freshworks SSO** option in Appliance Manager, under **Global Settings > SAML/SSO Settings**.
