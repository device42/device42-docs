...
We're actively working to expand and improve the Device42-Freshservice integration for specific assets. Recently, we've worked on mapping the following cloud-infrastructure relationships:
