...
- Kubernetes Cloud: Device42 can discover the relationships between Kubernetes assets and make that data available in Freshservice, so you can see which assets are impacted when an incident or change-management request occurs.
