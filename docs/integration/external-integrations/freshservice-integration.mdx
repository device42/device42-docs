...
To set up SSO, you need a user account in Device42 that mirrors a user account in Freshservice with same associated email address. That is, you need to have an admin user in Device42 with the same email address as your Freshservice agent. 
