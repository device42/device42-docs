...
From Freshservice, navigate to the settings page of the Device42 integration app:
...
:::tip
Use the InsightsAI chat under **Analytics > InsightsAI** to quickly interpret DOQL query snippets in the context of the Device42 data tables.
:::
