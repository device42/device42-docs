...
This page is for administrators who want to use Device42 as an assessment tool within Azure Migrate and export discovered business applications from Device42 to Azure for migration planning. By the end, your Device42 business application data appears in the Azure Migrate portal for assessment.
...
To export data from Device42 to Azure Migrate, make sure you have:
- An Azure account with access to the Azure portal
- An Azure Migrate project (created in the [Setting up Device42 from the Azure Migrate Portal](#setting-up-device42-from-the-azure-migrate-portal) section below)
- An Azure Active Directory app registration with a client secret, assigned the **Contributor** role on the subscription
- The following details collected from Azure: **Tenant ID**, **Subscription ID**, **Client ID**, **Client Secret**, and the **Migrate Project Name**
- A running Device42 instance with business applications to export
