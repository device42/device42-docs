...
This page is for administrators who are moving from Aperture VISTA to Device42. By the end, your Aperture VISTA data is imported into Device42, which creates the building, data center, and rack configurations for your rack-mounted devices.
...
- Access to the Aperture SQL Server database, with permission to create and run views
- The [Aperture VISTA views](https://www.device42.com/migrations/aperture/) downloaded
- A tool that can save query results as `.csv` or Excel files, such as SQL Server Management Studio
- The [Device42 Bulk Import Tool](https://www.device42.com/bulk-data-management/) downloaded
