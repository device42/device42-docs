...
- The CyberArk AIMWebService API available, which requires the [Central Credential Provider (CCP) plugin](https://docs.cyberark.com/credential-providers/latest/en/content/ccp/installation.htm) purchased and installed on CyberArk
