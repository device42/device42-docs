...
Download the `.exe` installer from the [Device42 Miscellaneous Tools page](https://www.device42.com/miscellaneous-tools/). Double-click the installer on a Microsoft Windows host. Follow the instructions on the screen. Click **Next** until you see **Installation Complete**:
...
7. If you selected **Write a query to specify the data to transfer**, enter your query. Otherwise, skip this step.

![Provide source query](/assets/images/provide-source-query.png)

8. If you selected **Copy data from one or more tables or views**, select the views you want to copy:
