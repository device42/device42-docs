...
- [Amazon Web Services – Installation](getstarted/deploy-device42/installation-amazon-web-services.mdx)

- [Microsoft Azure – Installation](getstarted/deploy-device42/installation-microsoft-azure.mdx)
