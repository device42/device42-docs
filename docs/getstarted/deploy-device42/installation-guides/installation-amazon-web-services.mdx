...
- If the update page offers a newer release, enter your work email and install the update by following the [Device42 Upgrade Steps](https://docs.device42.com/administration/updating-device42/). If you're working with a new appliance with no data, skip the backup step.
