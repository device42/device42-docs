...
Note that while the above linked page includes an **Initial (First-Boot) Network Configuration** section for configuring the Remote Collector, we recommend you instead reference the [Remote Collector Configuration](configuring-remote-collector.mdx) guide.
