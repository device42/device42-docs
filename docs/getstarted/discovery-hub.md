...
Once you have entered the information, click on the bright green **Start** button. 

The scan will start immediately. As pictured below, you will see the green start notification, a percentage ticker showing your completion status, and information on the six categories of assets: **Windows**, **Nix**, **Network Devices**, **Hypervisors**, **Other/Unknown** and **Unreachable**.
...
The **Windows**, **Nix**, **Network** and **Hypervisors** categories are straightforward. However, some network devices that run Linux under the hood can be miscategorized. We have implemented Configuration Options to help ensure these items are grouped correctly. 
...
Locate the **Configure Network Scan Options** by clicking on the button with the **sliders** icon to the right of the **Select RC** dropdown menu.
