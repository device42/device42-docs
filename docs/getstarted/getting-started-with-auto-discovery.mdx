...
Note that the Verify and Schedule tasks can be performed immediately following Task 2—Create and Run Discovery Jobs for each discovery job (vs. validating and scheduling after running all the discovery jobs).
...
See the [Autodiscovery Best Practices](/auto-discovery/autodisc-best-practices.mdx) page.
...
:::tip
To view a video on creating an SNMP discovery job, click [here](https://device42.wistia.com/medias/ig2udde5c4).
:::
...
Click [here](/auto-discovery/virtual-machine-auto-discovery.mdx) for a full list of supported Platforms.
...
Click [here](/auto-discovery/virtual-machine-auto-discovery.mdx) for more detail regarding Hypervisor Autodiscovery. This should be your first place to look when troubleshooting Hypervisor discovery job issues.

:::tip
To view a video that discusses Best Practices for Hypervisor discovery jobs, click [here](https://device42.wistia.com/medias/x60qk3xtub).
:::
...
- There are sometimes failures when discovering Windows operating system-based devices. Use the [Windows Authentication Troubleshooting Checklist](/getstarted/deploy-device42/windows-discovery-service-installation.mdx#troubleshooting) to help you investigate and resolve these failures. If you are unable to resolve these failures, please contact Device42 Support for assistance.
...
:::tip
To view a video on creating a Windows discovery job, click [here](https://device42.wistia.com/medias/igs49h2uwv).

To view a video on troubleshooting common Windows discovery job issues, click [here](https://device42.wistia.com/medias/2p1jvdo0u3).
:::
...
:::tip
To view a video on creating a Linux discovery job, click [here](https://device42.wistia.com/medias/uy59cjoq24).
:::
...
Click the following links for discovery details for [AWS](/auto-discovery/cloud-auto-discovery/aws-autodiscovery.mdx), [MS Azure](/auto-discovery/cloud-auto-discovery/azure-autodiscovery.mdx), [Google Cloud](/auto-discovery/cloud-auto-discovery/google-cloud-platform-autodiscovery.mdx), and [Kubernetes](/auto-discovery/cloud-auto-discovery/kubernetes-autodiscovery.mdx) Cloud discovery jobs. Regarding Kubernetes, click [here](/auto-discovery/cloud-auto-discovery/kubernetes-autodiscovery.mdx#provisioning-a-service-account) for information regarding provisioning a Service Account.
...
Click [here](/auto-discovery/storage-arrays-autodiscovery/index.mdx) to view more information about Storage Arrays, including viewing and editing storage arrays, viewing arrays mapped to devices, viewing storage resource maps and trend graphs, and importing and exporting Storage Array discovery jobs.
...
:::tip
To view a video on viewing the results from Certificates discovery jobs, click [here](https://device42.wistia.com/medias/xfytarrb11).
:::
...
- **Meraki API key:** Click [here](https://documentation.meraki.com/General_Administration/Other_Topics/Cisco_Meraki_Dashboard_API#Enable_API_access) for Meraki instructions to receive your API key.
...
- **IBM API key:** Click [here](https://www.ibm.com/support/pages/ibm-support-api-ibmsn) to log in to your IBM account to access your warranty lookup information.
...
Given the variety of Discovery platforms, we recommend you click [here](/auto-discovery/load-balancers.mdx) to follow the steps to create these jobs. This page also includes prerequisites and discovery options. To run the created job, click the checkbox next to the discovery job(s) and choose **Actions > Run Selected Jobs**.
...
After running a discovery job you will be presented with the Job Status. It will include:
...
:::tip
To view a video providing more information about Unprocessed Device Records, click [here](https://device42.wistia.com/medias/8nrkbskqgm).
:::
...
Should you have questions or issues, please first access [The Hitchhiker's Guide to Device42](https://docs.device42.com/), our online documentation page. You can easily search this guide for any questions you may have. You may also access the [Device42 Support page](https://support.device42.com) where you can submit a request, access our Knowledge Base, or access other general information.
