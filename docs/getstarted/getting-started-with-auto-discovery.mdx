...
- There are sometimes failures when discovering Windows operating system-based devices. Use [Appendix B](/getstarted/deploy-device42/windows-discovery-service-installation.mdx#troubleshooting) to help you investigate and resolve these failures. If you are unable to resolve these failures, please contact Device42 Support for assistance.
