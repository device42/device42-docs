...
When the job is created successfully, you will see the screen below. You can close the window and go back to your scans, or
 click the link to be taken to the job page. You can edit job settings from the job page.
