...
Enter the IP information in the box highlighted in the image below and click on the **+** button. You can enter as many targets as you like but the more targets, the longer the scan will likely take. 
...
Optionally, you may edit the speed and subsequent accuracy of your scans. Fast scans will run as quickly as possible, while moderate and normal scans will run slower. The relative quickness of the scan is determined by the size of the ranges entered. 
...
- We recommend running one scan at a time, at least initially, to inundate the network.
