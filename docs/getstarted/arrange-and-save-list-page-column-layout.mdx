...
Each list page consists of a table with sortable columns displaying the records, a **Select an action** dropdown that includes bulk actions like delete and export actions, a search bar, and filters. 
...
Create a new default view for a list page by rearranging the columns and the sorting order of the records, and saving the changes.
