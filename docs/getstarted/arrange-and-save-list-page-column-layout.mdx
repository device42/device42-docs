...
Each category of data (devices, assets, administrators) or tasks (webhooks, autodiscovery) in Device42 are displayed in what we refer to as a 'list page' and is the view you see when clicking on most items on the Main Appliance menu. 

List pages consists of a table with sortable columns displaying the records, an **Action** dropdown that includes bulk actions like delete and export actions, a search bar, and filters. 

This guide explains how to resize column widths, rearrange columns, and save the column layout as a default view for list pages.

## Resize Column Widths

Control the amount of characters visible in column cells by dragging the column heading divider to resize the column width. 

![Column drag](/assets/images/arrange-and-save-list-page/column-drag-trimmed.gif)

## Rearrange and Save List Page Column Layout
