...
:::tip
This is the third phase (Data Validation) in the Device42 implementation process. See [How is Device42 Implemented?](/getstarted/how-is-device42-implemented.mdx) for an overview of all four phases.
:::
