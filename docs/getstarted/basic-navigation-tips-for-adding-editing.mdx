...
The save toolbar is at the bottom of the add and edit forms. You can **Save** your input and view the result, **Save and continue editing the object**, or **Save and add another** object. You can also **Delete** the CI object from the toolbar in the top-right corner of the screen. 
