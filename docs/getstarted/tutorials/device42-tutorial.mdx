...
Our three tutorials and selection of [how-to videos](docs/how-to-videos/index.md) familiarize you with the Device42 system and address common questions.
...
3. The [Device42 user interface tutorial](getstarted/tutorials/tutorial-navigating-the-device42-user-interface.mdx) provides a guided exploration of the Device42 core features using your data.
