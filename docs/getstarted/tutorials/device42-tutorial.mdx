...
2. The [Loading Data Using Spreadsheets Tutorial](/getstarted/tutorials/device42-tutorial.mdx) uses spreadsheets to load data. There is no scripting involved. If you are fairly certain that you will never script API calls, this is the tutorial you should use.
