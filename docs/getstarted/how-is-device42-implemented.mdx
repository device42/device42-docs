...
This page is for implementers setting up Device42 for the first time. It gives you a high-level overview of the four phases so you know what to expect before working through each one in the pages that follow.
...
![The 4 Ds of Device42](/assets/images/4-ds-flow-v2.png)
