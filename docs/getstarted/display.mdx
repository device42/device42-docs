...
This page is for implementers and reporting leads who have completed the Data Validation phase and are ready to make the discovered data useful to the wider organization. It covers the fourth and final phase of the implementation process (Display), where you translate validated data into reports, dashboards, and visualizations that support business decisions. See [Implementation Overview](/getstarted/how-is-device42-implemented.mdx) for a summary of all four phases.

## Prerequisites

Before starting the Display phase, make sure you have:
- Completed the [Data Validation phase](/getstarted/data-validation.mdx): discovered data reviewed and confirmed accurate
- User accounts created for stakeholders who will access reports and dashboards (see [adding administrators](/administration/add-an-active-directory-user-as-a-device42-administrator.mdx) and [role-based access control](/administration/role-based-access-control/index.mdx))
- Device42 Academy reporting course completed (recommended)
...
sources={{
    light: useBaseUrl('/assets/images/display/create-standard-report-light.png'),
    dark: useBaseUrl('/assets/images/display/create-standard-report-dark.png'),
}}
/>
...
- The [Database Viewer Schema](reports/device42-doql/db-viewer-schema.mdx) page explains how to view Device42's Entity Relationship Diagram and Data Dictionary.
    ...
    alt="Data dictionary"
    sources={{
        light: useBaseUrl('/assets/images/display/data-dictionary-light.png'),
        dark: useBaseUrl('/assets/images/display/data-dictionary-dark.png'),
    }}
    />
...
- The [InsightsAI Chat](reports/device42-doql/insightsai.mdx) page explains how to use natural language descriptions to generate DOQL queries and tailored reports.
    ...
    alt="InsightsAI chat"
    sources={{
        light: useBaseUrl('/assets/images/display/insightsai-light.png'),
        dark: useBaseUrl('/assets/images/display/insightsai-dark.png'),
    }}
    />
