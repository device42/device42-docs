...
Save the `vmId` value, which you will use as the password for the following:

- SSH login as the default **device42** user.
- Logging in to the D42 Main Appliance as the default **admin** user.
- Logging in to the Appliance Manager as the default **d42admin** user.
