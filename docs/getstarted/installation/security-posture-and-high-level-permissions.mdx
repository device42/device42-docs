...
- All data in transit from the Windows Discovery Service (WDS) to the Remote Collector (RC), and from the RC to the Main Appliance (MA) is transferred via Secure Sockets Layer (SSL) or HTTPS.
