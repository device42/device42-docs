...
Refer to [our licensing page](administration/licensing.mdx#upload-a-new-license) for information on managing licenses.
...
For more information on backups and restores, see [Setting up backup via Device42 Appliance Manager](administration/appliance-manager/setting-up-backup-device42-appliance-manager.mdx).
