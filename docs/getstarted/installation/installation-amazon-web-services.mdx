...
The Device42 Remote Collector (RC) is only available via manual installation. To request access, please submit a ticket to the Device42 RC Amazon Machine Image (AMI) and include the following information:
