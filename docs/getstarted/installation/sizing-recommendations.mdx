...
Use these sizing recommendations below to properly provision your Device42 Main Appliance, Remote Collectors, and Windows Discovery Service. 

The sizing requirements depend on the size of the environment and Device42 features used.
