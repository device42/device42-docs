...
Before you begin the technical installation, it's worth taking a moment to set your implementation up for success on the organizational side. This page is for project leads and implementation teams and covers the non-technical factors that most often determine whether a Device42 rollout goes smoothly.

Based on experience across thousands of customer implementations, the factors below have the biggest impact on outcomes. Give each one careful consideration before you start.
...
You can contact Support via email or our Support Portal. Note that you can contact a Device42 Support agent Monday through Friday from 7am through 6pm ET, and again from 11pm through 6am ET. You can also access our Support and Knowledge Base Portal at https://support.device42.com, and can email support at support@device42.com.
