...
:::caution
Advanced Reporting will be removed from the product in a future release. Use [Standard Reports](reports/reports/standard-reports.mdx) or [Insights+](reports/reports/insights-plus.mdx) when creating new reports. Administrators can [hide the Advanced Reporting menu](reports/reports/advanced-reporting.mdx#hide-the-advanced-reporting-menu) for all users.
:::
