...
- **Print DPI:** Should match the print DPI in your label printer settings. See [Printing QR Codes from IE](infrastructure-management/mobile-inventory/printing-qr-codes-from-ie.mdx) for a known DPI workaround.
