...
- **Print DPI:** This is critical for printing. It should match the print DPI in your label printer settings. See [Printing QR Codes from IE](infrastructure-management/mobile-inventory/printing-qr-codes-from-ie.mdx) for a known DPI workaround.
...
You can assign QR codes or barcodes in bulk from the device or asset list page. See [Bulk QR and Barcode Printing](infrastructure-management/mobile-inventory/bulk-qr-printing.mdx) for details.
