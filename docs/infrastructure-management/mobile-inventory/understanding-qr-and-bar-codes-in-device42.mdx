...
- **Print DPI:** Should match the print DPI in your label printer settings. See [Printing QR Codes from IE](./printing-qr-codes-from-ie.mdx) for a known DPI workaround.
...
You can assign QR codes or barcodes in bulk from the device or asset list page. See [Bulk QR and Barcode Printing](./bulk-qr-printing.mdx) for details.
