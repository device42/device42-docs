...
You can manually import certificates by clicking **Create** from the certificate list page and selecting **Load from File**. Device42 supports PEM, ASN.1, and PKCS12 (pfx/p12) certificate file formats.
