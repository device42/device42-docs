...
You can configure alerts to notify you when software license thresholds are reached or prohibited software is detected. For full details on setting up alerts and managing notifications, see [Software Licensing Alerts and Notifications](software-licensing-alerts-and-notifications.mdx).
