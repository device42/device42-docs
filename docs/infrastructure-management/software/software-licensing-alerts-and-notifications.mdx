...
You can carry out bulk actions for notifications using the **Select an action** dropdown menu. Select the relevant notifications from the table, then choose one of the following actions and confirm the dialog to execute it:
