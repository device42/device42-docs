...
- **Delete**: Choose whether to delete the selected notifications immediately or only after confirmation. If the condition re-occurs, a new alert and notification will be created.
