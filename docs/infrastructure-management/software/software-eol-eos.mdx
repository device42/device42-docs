...
Select one or more **Software** entries, select an action from the **Actions** dropdown menu, and confirm it in the dialog to apply the action to the selected entries.
...
Click the **plus icon** next to the **Software:** field to mark an existing software component as in use. In the **Select Software Component** dialog, click the software component **Name** to add it to the **Software EOL / EOS** list page. Enter the software **Version**, **End of Life Date**, and **End of Service Date**.
