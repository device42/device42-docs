...
Click to select the **Software** you want to add as in use. Device42 displays the Select Software Component dialog. You can add a new component from this dialog. Click on the name of the component to add. Enter the software **Version**, then select the **End of Life** and **End of Service** dates.
