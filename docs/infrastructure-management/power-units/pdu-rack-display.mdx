...
Rack-mounted PDUs display like any other device in the rack. Half-depth PDUs are greyed out on the other side of the rack in the rack display (or if you have another device mounted, then the PDU is not visible).
