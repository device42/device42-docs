...
You can create an ATS in Device42 by going to _Infrastructure > Power Units > Power Units_. Click _Create_ at the top right of the Power Units list page. On the new screen, name your ATS and select ATS as power unit type.

### Connecting ATSs to PDUs

To connect an ATS to a PDU, you do so from the PDU page. Browse to the PDU you would like to connect to the ATS and in Edit mode change the _Content Type_ of the port you are connecting to _Power Unit,_ and then using the Object ID _plus icon_, select the ATS you would like to connect to the PDU.
