...
In this section, we will discuss Power Distribution Unit (PDU) ports. To edit PDU ports, open any PDU CI and **Edit** mode via the main menu: **Infrastructure > Power Units > Power Units**.
...
- **Override Watts:** Enter a value, in Watts, to override the wattage detected from hardware - _optional_.
...
To see the PDU list view and a high-level overview of the PDUs you have discovered in Device42navigate to **Infrastructure > Power Units > Power Units** from the main menu.
