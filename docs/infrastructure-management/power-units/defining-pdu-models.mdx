...
:::note
You cannot add ports directly to a PDU. PDU ports can only be created based on PDU models, so the model must be configured correctly before you create the PDU.
:::
