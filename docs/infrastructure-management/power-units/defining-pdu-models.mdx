...
:::note
This step is critical if you want to define ports for your PDUs. You cannot add ports directly to a PDU — **PDU ports can only be created based on PDU models.**
:::
