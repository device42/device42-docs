...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/power-units/mapped_device_PDU-HL.png'),
    dark: useBaseUrl('/assets/images/power-units/mapped_device_PDU-HL.png'),
  }}
  style={{ width: '110%' }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/power-units/Device_mapped_PDU-hl.png'),
    dark: useBaseUrl('/assets/images/power-units/Device_mapped_PDU-hl.png'),
  }}
  style={{ width: '110%' }}
/>
