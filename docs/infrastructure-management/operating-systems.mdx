...
See the [Operating System Attributes](auto-discovery/enrichai-data/index.mdx#operating-system-attributes) and [Key Support Dates](auto-discovery/enrichai-data/index.mdx#key-support-dates) sections of the [Enriched Data](auto-discovery/enrichai-data/#operating-system-attributes) page for the list of fields that can be populated through the data Normalization and Enrichment Service.
