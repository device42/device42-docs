...
## Power RC Prerequisite

First, follow the instructions to setup a Remote Collector (RC) here: [Remote Collector - Installation](/getstarted/deploy-device42/remote-collector-rc-installation.mdx).
