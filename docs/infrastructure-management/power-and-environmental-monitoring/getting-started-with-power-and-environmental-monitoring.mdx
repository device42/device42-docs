...
When sensors are discovered, they are created with asset records in Device42. Navigate to **Resources > Assets > All Assets** and filter by `Type="Sensor"` to see all PDU-attached sensors. For more information, see [Environmental Monitoring](/infrastructure-management/power-and-environmental-monitoring/environmental-monitoring.mdx).
