...
**Note that information below this line only applies to Legacy Power Appliances, which were superseded by RCs (remote collectors) in late 2017**.


## Legacy Documentation - Standalone Power Appliance, Depreciated 2017

**Note to Power Monitoring Users: The Standalone Power Appliance is being deprecated, and all related functionality is now available in Remote Collectors (RCs). Please utilize RCs for power / environmental monitoring going forward. See the [Remote Collector page](auto-discovery/remote-collector-rc.mdx) for setup details and for information on obtaining a Remote Collector going forward!**
...
\- [Microsoft Hyper V](getstarted/installation/installation-microsoft-hyperv.mdx)  
\- [vCenter Server](getstarted/installation/installation-vcenter-server.mdx)
