...
When you drill into a PDU, you will see power details for both **Infeeds** and **Ports** (outlets). In the example, the PDU has three infeeds and 24 outlets as visualized under the **Connectivity** tab:
