...
Navigate to **Resources > Network Devices > Ports** from the main menu to open the Ports list page. 
...
The Module, Asset, and the Network Switch 2nd associations can be done efficiently using [switch templates](switch-templates.mdx).
