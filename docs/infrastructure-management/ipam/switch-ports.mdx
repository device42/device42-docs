...
Navigate to the Ports list page under **Resources > Network Devices > Ports** from the main menu. 

From the list page you can view and edit existing switch ports by clicking on any port ID. Add one or more new ports by clicking the **+ Create** button on the upper right:
...
You can also see a list of associaed Ports via the **Ports** section on the device page:
...
Module, Asset and the Network switch 2nd association can be done efficiently using [switch templates](switch-templates.mdx).
...
To add a new stacked switch, head to **Infrastructure > Hardware Models** and click **+ Create **. Create a new device hardware model by supplying a **Name**, **Physical Subtype**, and other basic information, check the **Network Device** checkbox. 
...
Scroll down the Add Asset page, click **Add another Asset Device Relation**, and use the dropdown to associate the switch to the new asset.
