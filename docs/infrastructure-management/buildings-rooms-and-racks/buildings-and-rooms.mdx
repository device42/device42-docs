...
You can set the object colors to denote usage or temperature information. Choose between the **Usage Heatmap** and **Temperature Heatmap** options under the **Rack color** menu. The legend on the right changes accordingly to the selection.
...
These options are saved in cookies, so you don't have to reselect the combination of options that works best you when revisiting the page.
