...
Cables also have their own unique properties. In addition to length, connector type, and location, cables support [custom fields](/administration/custom-key-value-pairs-explained).
