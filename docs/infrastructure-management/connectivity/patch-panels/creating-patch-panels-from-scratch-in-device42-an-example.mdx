...
In this example, ports from switch-01 are patched to Panel A. (You can create switch ports in bulk using switch templates, as discussed under [Switch Templates](/infrastructure-management/ipam/switch-templates).)
