...
A **parts slot** is a physical receptacle on a device chassis (for example, a RAM slot or drive bay) that can accept a part from inventory. Parts slots are defined on hardware models — see [Device Parts Slots](/infrastructure-management/devices/device-parts-slots).
