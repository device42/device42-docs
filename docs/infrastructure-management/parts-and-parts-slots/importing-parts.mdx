...
<ThemedImage
  alt="Tools menu imports exports option"
  sources={{
    light: useBaseUrl('/assets/images/importing-parts/tools-imports-exports-light.png'),
    dark: useBaseUrl('/assets/images/importing-parts/tools-imports-exports-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Current data export spreadsheet"
  sources={{
    light: useBaseUrl('/assets/images/importing-parts/current-data-export-light.png'),
    dark: useBaseUrl('/assets/images/importing-parts/current-data-export-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Download sample import file"
  sources={{
    light: useBaseUrl('/assets/images/importing-parts/download-sample-file-light.png'),
    dark: useBaseUrl('/assets/images/importing-parts/download-sample-file-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Sample import spreadsheet with help comments"
  sources={{
    light: useBaseUrl('/assets/images/importing-parts/sample-spreadsheet-help-light.png'),
    dark: useBaseUrl('/assets/images/importing-parts/sample-spreadsheet-help-dark.png'),
  }}
/>
...
<ThemedImage
  alt="Populated sample import spreadsheet"
  sources={{
    light: useBaseUrl('/assets/images/importing-parts/populated-sample-sheet-light.png'),
    dark: useBaseUrl('/assets/images/importing-parts/populated-sample-sheet-dark.png'),
  }}
/>
