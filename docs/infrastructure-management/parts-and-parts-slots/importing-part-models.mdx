...
For information on port layouts and port templates for part models, see [Part Model Templates](/infrastructure-management/parts-and-parts-slots/part-model-templates).
...
To add actual parts to the inventory for these models, see [Import Parts](/infrastructure-management/parts-and-parts-slots/importing-parts).
