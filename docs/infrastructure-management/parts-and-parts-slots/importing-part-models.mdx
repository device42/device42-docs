...
This page explains how to import part models using API imports. The process involves downloading a sample template, populating it with your data, and uploading it back to Device42.

For a detailed explanation of part models and parts, see [Part Model Templates](/infrastructure-management/parts-and-parts-slots/part-model-templates.mdx).
...
To add actual parts to the inventory for these models, see [Import Parts](/infrastructure-management/parts-and-parts-slots/importing-parts.mdx).
