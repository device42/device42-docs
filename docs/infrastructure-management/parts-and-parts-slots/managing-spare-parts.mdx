...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/managing-spare-parts/view-parts-model-light.png'),
    dark: useBaseUrl('/assets/images/managing-spare-parts/view-parts-model-dark.png'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/managing-spare-parts/parts-menu-highlighted-light.png'),
    dark: useBaseUrl('/assets/images/managing-spare-parts/parts-menu-highlighted-dark.png'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/managing-spare-parts/add-parts-model-button-light.png'),
    dark: useBaseUrl('/assets/images/managing-spare-parts/add-parts-model-button-dark.png'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/assets/images/managing-spare-parts/parts-model-type-dropdown-light.png'),
    dark: useBaseUrl('/assets/images/managing-spare-parts/parts-model-type-dropdown-dark.png'),
  }}
/>
...
<ThemedImage
  alt="CPU RAM and hard disk specific attributes"
  sources={{
    light: useBaseUrl('/assets/images/managing-spare-parts/cpu-ram-hdd-attributes-light.png'),
    dark: useBaseUrl('/assets/images/managing-spare-parts/cpu-ram-hdd-attributes-dark.png'),
  }}
/>
