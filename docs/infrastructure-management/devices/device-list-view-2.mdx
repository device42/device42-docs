...
You can add or remove multiple tags to one or multiple devices at a time from the devices list page.

Select one or more devices and click **Add tags to selected items** or **Remove tags from selected items** from the **Actions** dropdown menu. 

<ThemedImage
  alt="Add or remove tags Actions"
  sources={{
    light: useBaseUrl('/assets/images/device-list/add-remove-tags-light.png'),
    dark: useBaseUrl('/assets/images/device-list/add-remove-tags-dark.png'),
  }}
/>

Type in the textbox to search for specific tags to add or remove.

<ThemedImage
  alt="Search tags"
  sources={{
    light: useBaseUrl('/assets/images/device-list/bulk-tag-search-light.png'),
    dark: useBaseUrl('/assets/images/device-list/bulk-tag-search-dark.png'),
  }}
/>
