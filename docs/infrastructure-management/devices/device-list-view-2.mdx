...
If you've made changes to the filter that you don't want to keep, click the **Reset** option to revert to the original saved filter.
...
You can add or remove multiple tags for one or multiple devices at a time from the Devices list page.

Select one or more devices and choose either **Add tags to selected items** or **Remove tags from selected items** from the **Actions** dropdown menu. 
...
Start typing in the textbox to search for specific tags you want to add or remove.
