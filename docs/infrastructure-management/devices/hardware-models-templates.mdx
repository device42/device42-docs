...
You can optionally choose to add the merged hardware model names as aliases in the master hardware model, but this is strictly for reference and all existing devices will be associated with the new master hardware model.
