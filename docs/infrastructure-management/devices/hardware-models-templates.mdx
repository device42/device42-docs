...
You can upload images (like front and back pictures of devices) into Device42. These uploaded images can then be associated with various items, such as Hardware Model templates, to provide visual context.
...
<ThemedImage
  alt="Adding images via the Image Files upload page"
  sources={{
    light: useBaseUrl('/assets/images/hardware-model-templates/add-image-file-light.png'),
    dark: useBaseUrl('/assets/images/hardware-model-templates/add-image-file-dark.png'),
  }}
...
You can then add these images to hardware models by going to the hardware model edit page and selecting the image from the dropdown. You can add images for the front and back of the device. 
