...
## Edit the Layout of an Existing Hardware Device
...
### Device Type Bulk Edit

Change the **Type** property for multiple devices at once with the **Change type** bulk action. For example, you can change the **unknown** device type value to **physical**. 
...
4. Choose the new device type for the selected devices and click **Change**. 
...
You can upload images (like front and rear views of devices) into Device42 and associate them with Hardware Model templates for visual context.
...
Navigate to the **Hardware Model** list page under **Infrastructure > Hardware Models** and select the two or more models you wish to merge. From the **Action** menu, select **Merge selected hardware models**.
