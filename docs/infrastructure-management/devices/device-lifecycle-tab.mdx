...
As of version 19.05 and later of the Device42 UI, the **Lifecycle Tab** is only available using the Device **Legacy** view. 

As of version 19.05 and later, from the device details view, the following sections that were under the **Lifecycle Tab** can be located using the right **Breakdown** panel:
- **Asset Lifecycle**
