...
Version 19.05 introduces an improved details view page. Details are organized into sections (previously tabs) and these sections are navigable using the **Breakdown** panel on the right.

The **Object List** panel on the right consists of a selection of devices based on the list page grid from the previous screen. Any filters or searches made on the device list page will be reflected in the **Object List** panel.

Hide and expand the **Object List** and **Breakdown** panels as needed.
