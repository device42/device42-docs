...
Version 19.05 introduces an improved details view page. If your prefer the previous layout, you can revert to the **Legacy** details layout. 

There are two new panels that you can hide and expand as needed:

- **Object List** (left): Navigate to the detail view of different devices without going back to the list page. The items that appear in this panel include the device selection from the list page grid from the previous screen; any filters or searches made on the device list page are displayed.
...
- Subpage buttons are now displayed in the device details view. Devices with conditional subpages, like Switch Ports and Power Consumption, with also be displayed in this row of subpage buttons. Typical subpages include:
...
- Columns under the **Asset Lifecycle** sub-view can now be sorted in ascending or descending order.
