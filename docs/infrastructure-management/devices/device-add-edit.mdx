...
- **Object List** (left): Navigate to the detail view of different devices without going back to the list page. This panel displays the device selection from the list page grid from the previous screen, as well as any filters or searches made on the Devices list page.
