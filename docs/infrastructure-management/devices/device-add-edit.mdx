...
- In v19.05, the Object Category field will be hidden if [Role-Based Access Control](/administration/role-based-access-control/#object-category-field) (RBAC) is off. Enable RBAC under **Tools > Settings > Global Settings** to see the field again. Alternatively, you can use the **Legacy View** to see the Object Category field.
