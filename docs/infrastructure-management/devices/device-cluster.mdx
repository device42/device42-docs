...
Start typing in the **Devices in Cluster** field to narrow down the list of available devices and make it easy to select one among hundreds or thousands of devices. Add new devices using the **plus sign** button.
