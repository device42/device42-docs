...
This section is about the Device42 for JSM app. Refer to the [Device42 for JSM Assets section](#configure-device42-for-jsm-assets-the-settings-tab) for information about the Device42 for JSM **Assets** app.
