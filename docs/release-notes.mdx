...
**Disclaimer:** Please consider the [Device42 blog](https://www.device42.com/blog/) as the authoritative source of release notes. The information below is taken from the blog and may not always be current.
...
Device42 19.06.00 was released on April 30th, 2025. In addition to bugs and minor UI enhancements, the following items were added or enhanced in 19.06: 
